...
import com.wons.memotalk.mainactivity.dao.MainMemoListDao;
import com.wons.memotalk.memotalkactivity.dao.MemoRoomDao;
import com.wons.memotalk.mainactivity.dao.TabDao;

@Database(entities = {Tab.class, MemoRoom.class, MemoText.class, MemoImg.class, MemoTodo.class, MemoUrl.class, MemoFile.class, MemoItem.class, ListIcon.class},version = 1)
public abstract class MainDatabase extends RoomDatabase {
    public abstract TabDao tabDao();
    public abstract MemoRoomDao memoRoomDao();
    public abstract MainMemoListDao mainMemoListDao();
}
